...
class GoodsAdmin(object):
    list_display = ["id","name", "shop_price", "add_time"]
    search_fields = ['name', ]
    list_editable = ["name", "shop_price"]  # 可以在列表页对字段进行编辑
    list_filter = ["name", "shop_price", ]
...
xadmin.site.register(Goods,GoodsAdmin)  #在xadmin中注册GoodsAdmin